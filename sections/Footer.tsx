...
export default function Footer() {
  return (
    <footer className="p-10 font-sans tracking-wide border-t-2 border-white/10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:flex lg:items-center">
          <ul className="flex space-x-6">
            <li>
              <Link href="https://x.com/CYBER_WORLD2507" className="inline-block">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-7 h-7 fill-gray-300 hover:fill-white"
                >
                  <title>X</title>
            ...
            <li>
              <Link href="https://www.instagram.com/hackademic2507" className="inline-block">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <Link href={'/mission'} className='text-gray-300 hover:text-white text-sm'>Our Mission</Link>
            </li>
            <li>
      ...
      <p className="text-gray-300 text-sm mt-10">© Hackademic. All rights reserved.</p>
    </footer>
  );
}
